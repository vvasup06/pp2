...
bg_image = pygame.image.load('images/MicrosoftTeams-image (2).png')
sec_img = pygame.image.load('images/MicrosoftTeams-image (1).png')
min_img = pygame.image.load('images/MicrosoftTeams-image.png')
